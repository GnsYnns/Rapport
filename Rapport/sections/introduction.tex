...
\begin{itemize}
    \item Identifier et restituer de manière rigoureuse les engagements, les organes de gouvernance et les indicateurs clés (\glos{KPI}) de la politique RSE d'Iveco Group.
    \item Analyser la mise en \oe{}uvre sociale, en particulier les politiques de Diversité, Équité et Inclusion (\glos{DEI}), de santé et de sécurité, ainsi que les initiatives communautaires.
...
L'analyse concerne Iveco Group dans sa globalité, en particulier les données publiées pour l'exercice 2025 (rapport annuel, \textit{GHG Statement}\footnote{Déclaration des émissions de gaz à effet de serre.}, documents thématiques RSE/DEI et politique de confidentialité). Le site de Haute-Goulaine sert de terrain d'observation concret pour illustrer les leviers d'action du numérique responsable.
...
Après cette présentation du contexte, le développement s'articule autour de trois parties :
...
La conclusion tire un bilan de cette analyse et propose des perspectives pour prolonger cette démarche.
